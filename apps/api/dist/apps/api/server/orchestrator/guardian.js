 ...
 */
export async function logToGuardian(entry) {
    try {
 ...
 */
export async function checkPermission(agentId, resource, action) {
...
export async function checkRateLimit(agentId, limit = 10, windowSeconds = 60) {
    const now = Date.now();
